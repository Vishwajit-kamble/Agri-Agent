...
export const translations = {
  en: {
    ...
    simulation: {
      ...
      subtitle: 'Prototype simulation to visualize how crop decisions may affect outcomes.',
      ...
      simulationMode: 'Simulation Mode: Prototype (Rule-based)'
    },
    homePage: {
  ...
  mr: {
    ...
    finance: {
      ...
      comingSoon: 'ही वैशिष्ट्य लवकरच येणार आहे.',
      insurancePlans: 'उपलब्ध विमा योजना',
      viewPlans: 'सक्रिय योजना पहा'
    },
    simulation: {
      title: 'डिजिटल ट्विन सिम्युलेशन',
      subtitle: 'पिक निर्णय परिणाम कसे प्रभावित करू शकतात ते दृश्यमान करण्यासाठी प्रोटोटाइप सिम्युलेशन.',
      ...
      simulationMode: 'सिम्युलेशन मोड: प्रोटोटाइप (नियम-आधारित)'
    },
    homePage: {
  ...
  hi: {
    ...
    finance: {
      ...
      comingSoon: 'यह फीचर जल्द ही आ रहा है।',
      insurancePlans: 'उपलब्ध बीमा योजनाएं',
      viewPlans: 'सक्रिय योजनाएं देखें'
    },
    simulation: {
      title: 'डिजिटल ट्विन सिमुलेशन',
      subtitle: 'प्रोटोटाइप सिमुलेशन यह दिखाने के लिए कि फसल निर्णय परिणामों को कैसे प्रभावित कर सकते हैं।',
      ...
      simulationMode: 'सिमुलेशन मोड: प्रोटोटाइप (नियम-आधारित)'
    },
    homePage: {
